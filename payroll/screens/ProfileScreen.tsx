    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileCard}>
          {loading ? (
            <ActivityIndicator size="large" color="#4285F4" style={{ paddingVertical: 40 }} />
          ) : (
            <>
              ...
              <View style={styles.badgeRow}>
                ...
                {department && (
                  <View style={styles.deptBadge}>
                    <MaterialCommunityIcons name="office-building-outline" size={14} color="#666" />
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Theme' as never)}>
            <MaterialCommunityIcons name="theme-light-dark" size={24} color="#666" />
            <Text style={styles.menuItemText}>Theme</Text>
            <MaterialCommunityIcons name="chevron-right" size={24} color="#999" />
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('Language' as never)}>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => navigation.navigate('PrivacyPolicy' as never)}>
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  profileCard: { backgroundColor: '#FFFFFF', alignItems: 'center', paddingVertical: 32, marginBottom: 16 },
  ...
  employeeCode: { fontSize: 12, color: '#999', marginBottom: 12 },
  ...
  deptBadge: {
    ...
    paddingVertical: 6, borderRadius: 16, backgroundColor: '#F5F5F5', gap: 4,
  },
  deptText: { fontSize: 12, color: '#666' },
  menuSection: { backgroundColor: '#FFFFFF', marginBottom: 16, paddingVertical: 8 },
  sectionTitle: {
    fontSize: 14, fontWeight: '700', color: '#999', paddingHorizontal: 20,
  ...
  menuItemText: { flex: 1, fontSize: 16, color: '#000', marginLeft: 16 },
  logoutButton: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    backgroundColor: '#FFFFFF', marginHorizontal: 20, marginTop: 8,
