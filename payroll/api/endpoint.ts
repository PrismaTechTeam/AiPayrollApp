...
const baseURL = getEnvVar('EXPO_PUBLIC_API_URL', 'https://smtp-reservation-store-italia.trycloudflare.com');
const baseWebSocketUrl = getEnvVar('EXPO_PUBLIC_WEBSOCKET_URL', 'https://smtp-reservation-store-italia.trycloudflare.com');
