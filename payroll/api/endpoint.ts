...
const baseURL = getEnvVar('EXPO_PUBLIC_API_URL', 'https://aside-cooperation-congress-constitutional.trycloudflare.com');
const baseWebSocketUrl = getEnvVar('EXPO_PUBLIC_WEBSOCKET_URL', 'https://aside-cooperation-congress-constitutional.trycloudflare.com');
